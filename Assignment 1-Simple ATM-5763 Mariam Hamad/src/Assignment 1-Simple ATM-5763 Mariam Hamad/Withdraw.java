...
public class Withdraw {
    ...
    labelError.setFont(new javafx.scene.text.Font("Arial", 13));
   
    labelError.setTextFill(Color.web("#F44336"));
    label.setPrefWidth(150);
    label.setPrefHeight(30);
    labelError.setPrefWidth(150);
    labelError.setPrefHeight(30);
          ...
          enter.setOnAction(new EventHandler<ActionEvent>(){
            ...
            public void handle(ActionEvent event) {
               ...
               String amount=amountLabel.getText();
                ...
                {
                         labelError.setText("Not enough balance!");
                }
            }                
        });
     }  
